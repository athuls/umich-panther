...
public class Config {
	...
	private static final double[] gpspoint1={2.36044174, 48.8545416, 213};
	private static final double[] gpspoint2={2.35349982, 48.85199862, 216.6};
	private static final double[] gpspoint3={2.35681238, 48.85296742, 217.6};
	private static final double[] gpspoint4={2.34642243, 48.85234462, 217.4};
	
	// Need to change to London coordinates
	public static final double[] OriginalGPSPoint = {2.3522219000000177, 48.856614, 214};	

	// Distances are in feet
	public static final double bearing1 = 110.963;
	public static final double bearing2 = 169.675;
	public static final double bearing3 = 140.364;
	public static final double bearing4 = 221.792;
	...
	*/
	...
	private static final String m_allPositions = Config.currentPath + "field_inspector_trail/ApproxApproachAcrossPlanet/ParisLocLinearInput";
