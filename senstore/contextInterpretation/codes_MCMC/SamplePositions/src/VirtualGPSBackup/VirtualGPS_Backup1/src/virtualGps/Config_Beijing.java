...
public class Config_Beijing {
	...
	private static final double[] gpspoint1={116.40570355, 39.91017123, 84.2};
	private static final double[] gpspoint2={116.40395139, 39.90488511, 80.3};
	private static final double[] gpspoint3={116.39989466, 39.90779412, 87.6};
	private static final double[] gpspoint4={116.41101028, 39.90991479, 56.9};
	
	// Beijing coordinates
	public static final double[] OriginalGPSPoint = {116.40752599999996, 39.90403, 70.3};	
